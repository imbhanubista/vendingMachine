    ...
    <div>
        <Center>
            <Box  p="4" m="8" borderRadius={"15"} shadow="lg" width={"80"}>
                <Center mb={"1"}>
                    <Text fontSize={"3xl"} color="twitter.700" fontWeight={"bold"}>Refund</Text> 
                </Center>
                <Center mb={"4"}> <Text>Enter purchase Token</Text></Center>

                {/* form */}
              <form onSubmit={handleSubmit(onSubmit)}>
              <Center mb="4">
                    <Input  placeholder="Enter purchase Token" textAlign={"center"} variant="filled" {...register("refCode")}/>
                </Center>
                <Center>
                    <Button size={"sm"} colorScheme="messenger" mb={"4"} type="submit">
                        Refund
                    </Button>
                </Center>
              </form>
                <Center>
                    <Button variant='link' textColor={"blue"}size='xs' onClick={homeNav}>Back Home</Button>
                </Center>
            </Box>
        </Center>
    </div>
